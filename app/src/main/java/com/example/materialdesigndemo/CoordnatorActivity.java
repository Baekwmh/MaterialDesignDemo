...
public class CoordnatorActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    private static final String NEWS_URL = "http://v.juhe.cn/toutiao/index";
    private static final int GET_NEWS = 1;

    private RecyclerViewActivity.NewsHandler handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coordnator_new);
        handler = new RecyclerViewActivity.NewsHandler(this);
    ...
    static class NewsHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            final CoordnatorActivity activity = (CoordnatorActivity) this.ref.get();
